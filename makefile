...
GHC_CC_OPT = -threaded -eventlog -rtsopts -package GLFW -fexcess-precision  -L/usr/local/lib -L/usr/lib -lstdc++ --make -odir `uname -m` -hidir `uname -m`
GHC_CC_OPTIMIZE = -O3 -optc-O3 -funbox-strict-fields -optc-msse2 -optc-msse3
# -fllvm
GHC_LD_OPT =
GHC_LD_PACKAGES =
