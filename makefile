...
GHC_CC_OPT = -threaded -rtsopts -O3  -fexcess-precision -optc-O2 -funbox-strict-fields -optc-mfpmath=sse -optc-msse2 -optc-msse3  -L/usr/lib --make -odir `uname -m` -hidir `uname -m`
GHC_LD_OPT = 
GHC_LD_PACKAGES =
